...
To compare with existing methods of combining \NN and rules, we also implement the \orange{famous} teacher-student network~\cite{hu2016harnessing}, which proves to perform well on various tasks.
...
\lb{probably, we can delete this paragraph?}

...
classification, sequence labeling, and etc. For example, in dialogue system, an \RE pattern \texttt{/\textasciicircum flights? from/} can
...
making it widely used in industry and especially in few-shot learning scenarios where the training data is limited.

...
\REs are often ensembled  with other
...
high precision, leaving the rest for data-driven methods.
...
a \RE \cyan{also} encodes a developer's knowledge for the problem domain, \red{which could be the informative words (\textbf{\textit{clue
words}}) within its \cyan{surface form} and so on.} %pattern.
...
This also provides us an opportunity to learn from various kinds of  \REs, 

...
a \RE \cyan{also} encodes a developer's knowledge for the problem domain. \red{The knowledge could be, for example,  the informative words
(\textbf{\textit{clue
words}}) within a \RE's \cyan{surface form}.} %pattern.
...
usefulness of \REs in real-world scenarios where the available annotated data can vary, we explore both the few-shot learning setting and

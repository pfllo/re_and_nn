...
\cyan{Besides considered as an independent classifier, }
% and existing approaches only scratch the surface of what could possibly be achieved.
a \RE \cyan{also} encodes a developer's knowledge of the problem domain, which indicates e.g., the informative words (\textbf{\textit{clue
words}}) within its \cyan{surface form}. %pattern.
...
tasks~\cite{goldberg2017neural}. \red{By doing so,

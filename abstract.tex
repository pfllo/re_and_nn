...
The success of many natural language processing (\NLP) models is bound by the number and quality of annotated data, but there is often a
...
(\RE) to improve supervised learning for \NLP?". In answer, we develop
 novel methods to exploit the rich expressiveness of
%the commonly used
\REs at different levels within a \NN, showing that the combination significantly enhances the learning effectiveness when a small number
 of training examples are available. We evaluate our approach by

...
\texttt{/Boston|Miami|LA|.../}. If \REs are use in the input (Sec.~\ref{fusion_with_input}) and the output layers
...
three target slot labels: \emph{fromloc.city}, \emph{toloc.city}, \emph{stoploc.city}. \cyan{The purpose of abstracting the \REtag to a

...
three related target slot labels: \emph{fromloc.city}, \emph{toloc.city}, \emph{stoploc.city}. The purpose of abstracting  \REtags to a
simplified version of the target slot labels is to

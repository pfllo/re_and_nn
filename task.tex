...
%When writing \REs, 
Intuitively, complicated \REs often lead to better performance but require more efforts to generate. %, \RE complexity is often an important trade-off that we need to make. Generally, 

...
Besides, since we consider few-short learning settings,  we also include memory module proposed by Kaiser et al.~\shortcite{kaiser2017learning}, which performs well in various few-shot datasets (\textbf{\texttt{+mem}}).\footnote{
